...
export default function StudentLogin() {
  ...
  var onSubmit = (e) => {
    ...
    axios
      .post("http://localhost:8080/student/studentlogin/"+login.uname+"/"+login.password, {
      ...
      .then((response) => {
        ...
        if (response.data === "pass") {
          ...
          AuthenticateService.studentLogin(login.uname);

          setLogin({ uname: '', password: '' });
          window.location = `/student-dash`;
        ...
        <MDBCol col='12'>
          ...
          <MDBCard className='bg-dark text-white my-5 mx-auto' style={{ borderRadius: '1rem', maxWidth: '400px' }}>
            <MDBCardBody className='p-5 d-flex flex-column align-items-center mx-auto w-100'>
              ...
              <div>
                <p className="mb-0">Don't have an account? <a href="/student-reg" class="text-white-50 fw-bold">Sign Up</a></p>
